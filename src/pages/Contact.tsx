...
const Contact = () => {
  ...
  return (
    <main className='contact-page'>
      ...
      <form id='contact-form' action="https://formsubmit.co/o.santxz@proton.me" method="POST">
        ...
        <input type="hidden" name="_next" value="https://dev-portfolio-will-santosx.vercel.app/sucesso"></input>
      </form>
    </main>
  )
}
